package org.jboss.teiid.embedded.samples.ws;
 ...
 *
 */
public class StateServiceCXFDispatchStAXSourceClient {
	...
	public static void main(String[] args) throws XMLStreamException {
		...
		StAXSource returnValue = dispatch.invoke(formStAXSource(StateServiceExample.GET_ALL));
		System.out.println(parseResult(returnValue.getXMLStreamReader()));
		
		returnValue = dispatch.invoke(formStAXSource(StateServiceExample.GET_ONE));
		System.out.println(parseResult(returnValue.getXMLStreamReader()));
	}
